	...
	<link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous"/>
      ...
      <body className={inter.className}>
        ...
        {children}
            ...
            <Script strategy="beforeInteractive" src="assets/vendor/flatpickr/js/flatpickr.min.js"></Script>
            <Script strategy="beforeInteractive" src="assets/vendor/choices/js/choices.min.js"></Script>
