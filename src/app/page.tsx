						...
						<div className="col-lg-4" suppressHydrationWarning>
							<div className="form-control-border form-control-transparent form-fs-md d-flex">
								...
								<div className="flex-grow-1">
									...
									<select className="form-select js-choice" data-search-enabled="true" suppressHydrationWarning>
						...
						<div className="col-lg-4">
							<div className="d-flex">
								...
								<div className="form-control-border form-control-transparent form-fs-md">
									...
									<input type="text" className="form-control flatpickr" data-mode="range" placeholder="Select date" value="19 Sep to 28 Sep"/>
								</div>
							</div>
						</div>
...
<section className="pb-2 pb-lg-5">
	<div className="container">
		...
		<div className="tiny-slider arrow-round arrow-blur arrow-hover">
			<div className="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items-xl="3" data-items-lg="2" data-items-md="1">
				{/* <!-- Slider item --> */}
				<div>
					<div className="card border rounded-3 overflow-hidden">
						<div className="row g-0 align-items-center">
							...
							<div className="col-sm-6">
								<img src="assets/images/offer/01.jpg" className="card-img rounded-0" alt=""/>
							</div>
				...
				<div>
					<div className="card border rounded-3 overflow-hidden">
						<div className="row g-0 align-items-center">
							...
							<div className="col-sm-6">
								<div className="card-body px-3">
									<h6 className="card-title"><a href="offer-detail.html" className="stretched-link">Up to 60% OFF</a></h6>
				...
				<div>
					<div className="card border rounded-3 overflow-hidden">
						<div className="row g-0 align-items-center">
							{/* <!-- Image --> */}
							<div className="col-sm-6">
								<img src="assets/images/offer/03.jpg" className="card-img rounded-0" alt=""/>
							</div>

							{/* <!-- Title and content --> */}
							<div className="col-sm-6">
								<div className="card-body px-3">
									<h6 className="card-title"><a href="offer-detail.html" className="stretched-link">Book & Enjoy</a></h6>
				...
				<div>
					<div className="card border rounded-3 overflow-hidden">
						<div className="row g-0 align-items-center">
							{/* <!-- Image --> */}
							<div className="col-sm-6">
								<img src="assets/images/offer/02.jpg" className="card-img rounded-0" alt=""/>
							</div>

							{/* <!-- Title and content --> */}
							<div className="col-sm-6">
								<div className="card-body px-3">
									<h6 className="card-title"><a href="offer-detail.html" className="stretched-link">Hot Summer Nights</a></h6>
	...
	<div className="container">
		<div className="row g-4 justify-content-between align-items-center">
			...
			<div className="col-lg-5 position-relative">
				...
				{/* <!-- Image --> */}
				<img src="assets/images/about/01.jpg" className="rounded-3 position-relative" alt=""/>
				...
				<div className="position-absolute bottom-0 start-0 z-index-1 mb-4 ms-5">
					<div className="bg-body d-flex d-inline-block rounded-3 position-relative p-3">	
						...
						{/* <!-- Element --> */}
						<img src="assets/images/element/01.svg" className="position-absolute top-0 start-0 translate-middle w-40px" alt=""/>
			...
			<div className="col-lg-6">
				...
				<p className="mb-3 mb-lg-5">Book your hotel with us and donot forget to grab an awesome hotel deal to save massive on your stay.</p>

				{/* <!-- Features START --> */}
				<div className="row g-4">
					{/* <!-- Item --> */}
					<div className="col-sm-6">
						<div className="icon-lg bg-success bg-opacity-10 text-success rounded-circle"><i className="fa-solid fa-utensils"></i></div>
